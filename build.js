...
${platform === 'arm' ? 'target_cpu=["arm"]' : ''}
    ...
    if (program.arch === 'ia32') {
        await execAsync('gn', 'gen', 'out/Default', '--args="chrome_pgo_phase=0 is_debug=false enable_nacl=false is_component_ffmpeg=true proprietary_codecs=true is_official_build=true target_cpu=\\"x86\\" ffmpeg_branding=\\"Chrome\\" --unsupported"');
